    ...
    <div class = "bodylo">
        ...
        <form method = "post" action="signinprocess.php">
            ...
            <div class="form">
                ...
                <img src = "image/user.png" width = "100px" class = "img">

               

                <input type="text" id ="name1" name="name1" placeholder="User Name : " required>
                <input type="password" id ="password1" name="password1" placeholder="Password : " required>

          

                <input type ="submit" value="Log In" class="btnn">
                

                <p class="link">Don't have an account <a href="registration.php"> Sign up </a> here</a></p>
